...
<form id="formulario" method="post" action="run/_nuevo_articulo.php" enctype="multipart/form-data" accept-charset="ISO-8859-1">
    ...
    <li>
        ...
        <input type="text" id="precio_compra" name="precio_compra" size="5" value="<?php echo round($articulo->precio_coste, 2); ?>"/> (sin IVA)
    </li>
    <li>
        <label>Precio venta</label>
        <input type="text" id="precio_venta" name="precio_venta" size="5" value="<?php echo round($articulo->precio_venta, 2); ?>"/> (sin IVA) 
